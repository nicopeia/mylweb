...
<section id="fondoServPy">
  <div class="overlayservPy">
  <div class="container">
  <div class="row">
    ...
    <div class="col-md-6 contenidoserv mt-5 py-5">
      ...
      <br><br>
              ...
              <h1 style="color:#fdfdfd" class=" display-2   text-left ">PYMES</h1>
              <p class="text-white lead mb-5">Nuestro equipo cuenta con profesionales dedicados a la prestación de servicios a pequeñas y medianas empresas, adaptándonos a sus necesidades, ya sea reforzando el circuito administrativo contable o en el outsourcing contable y/o impositivo.</p>
...
<div id="datos" class="container py-5">
...
<hr style="color: black;">
   ...
   <ul style="color:#2379EE">
     ...
     <li>Registración y control de transacciones y conciliaciones de cuentas.</li>
        <li>Colaboración en la implementación de sistemas de gestión contables </li>
           <li>Control periódico de la gestión administrativa contable </li>

                 <li>Confección de reportes gerenciales</li>
                    <li>Asesoramiento, confección y control de las DDJJ relativas a tributos nacionales y provinciales</li>
                    <li>Auditoría de sociedades de familia y pymes.</li>
                    <li>Confección de estados contables</li>
