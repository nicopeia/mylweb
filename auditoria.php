...
<div id="datos" class="container">
   ...
   <div class="col-md-12 py-5 text-black puntosInfo">
    ...
    <ul style="color:#2379EE">
         ...
         <li>Auditoría de estados contables bajo normas locales </li>
            <li>Auditoría de estados contables de entidades supervisadas por la CNV </li>
                  <li>Auditoría operativa y de procesos</li>
                  <li>Auditoría de cumplimiento</li>
                  <li>Verificación del cumplimiento de leyes y/o disposiciones de entes de control</li>
                     <li>Due Diligence</li>
