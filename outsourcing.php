...
<section id="fondoServout">
  <div class="overlayservout">
  <div class="container">
  <div class="row">
...
<br><br>
        ...
        <h1 style="color:#fdfdfd" class=" display-2   text-left ">OUTSOURCING</h1>
        <p class="text-white lead mb-5">Brindamos soluciones y tranquilidad a las empresas en el entorno de regulaciones fiscales y juridicas.</p>
...
<div id="datos" class="container">
   ...
   <div class="col-md-12 py-5 text-black puntosInfo">
    ...
    <ul style="color:#2379EE">
      ...
      <li>Start up administrativo – contable</li>
         <li>Transacciones en sistemas contables: </li>
            <li>Procesos Administrativos Contables </li>
                  <li>BPO- Bussinees Process Outsourcing</li>
                  <li>Proyecciones bancarias</li>
                     <li>Control presupuestario económico y financiero</li>
                     <li>Liquidación de impuestos mensuales</li>
                     <li>Monitoreo previsional y fiscal</li>
...
<h6 style="color:#2379EE">OUTSOURCING LABORAL Y PREVISIONAL</h6>
Contamos con un equipo de profesionales, especialistas.Nuestro conocimiento y experiencia se ve reflejada en la confianza de nuestros clientes.

 Garantizamos una excelente calidad de servicio y atención personalizada, permitiendo que puedan concentrarse en el foco de sus negocios.
</div>
...
<div class="bg-white  py-4">
   ...
   <div class="col-md-12 text-center plantilla">
     ...
     <li>  <p>Atención y/o preparación de Due Diligence</p></li>
     <li>   <p>Auditoría sobre liquidaciones terciarizadas</p></li>
