...
<section id="fondoServotro">
  <div class="overlayservotro">
  <div class="container">
  <div class="row">
    ...
    <div class="col-md-6 contenidoserv mt-5 py-5">
      ...
      <br><br>
              ...
              <h1 style="color:#fdfdfd" class=" display-2   text-left ">Otros Servicios</h1>
              <p class="text-white lead mb-5">Auditoria de procesos:Normativas SOX, Due Diligence, Precios de Transferencia, Informes Periciales.</p>
...
<hr style="color: black;">
   ...
   <ul style="color:#2379EE">
     ...
     <li>PREVENCIÓN LAVADO DE ACTIVOS</li>
        <li>CONTROL DE PROVEEDORES </li>
           <li>PRECIOS DE TRANSFERENCIA </li>

                 <li>INVESTIGACIÓN DE FRAUDES</li>
...
<div id="separador" class="py-5">
   ...
   <div class="col-md-12">
       ...
       <h3 class="text-center"style="color:#6ea4ee; font-weight: 600;">OFRECEMOS LA SOLUCION CONCRETA A CADA CLIENTE</h3>
