...
<section id="fondoServprev">
  <div class="overlayservprev">
  <div class="container">
  <div class="row">
    ...
    <div class="col-md-6 contenidoserv mt-5 py-5">
      ...
      <br><br>
              ...
              <h1 style="color:#fdfdfd" class=" display-2   text-left ">PREVISIONAL</h1>
              <p class="text-white lead mb-5">Asesoramiento y trámites jubilatorios, pensiones, reajustes.Atención de requerimientos de organismos de fiscalización y control.</p>
